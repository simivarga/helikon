...
const strings: Record<Locale, Record<string, string>> = {
  uk: {
    ...
    'rp.metaDesc':
      '{name} у готелі «Гелікон» у Яноші біля Берегового. {cap}, сніданок включено, від {price} ₴ за ніч. Бронюй онлайн або телефонуй.',
    'rp.hotel': 'Готель Гелікон',
    'rp.home': 'Головна',
    'rp.breadcrumb': 'Навігаційний ланцюжок',
    'rp.allRooms': 'Усі номери',
    'rp.priceLabel': 'Орієнтовна ціна',
    'rp.priceNote': 'Точну ціну на твої дати побачиш під час бронювання.',
    'rp.bookOnline': 'Забронювати на Booking.com',
    'rp.directTitle': 'Бронюй напряму',
    'rp.directText': 'Зателефонуй на рецепцію або напиши у WhatsApp. Підкажемо, чи є вільний номер на твої дати, і відповімо на запитання.',
    'rp.call': 'Зателефонувати',
    'rp.whatsapp': 'Написати у WhatsApp',
    'rp.stayTitle': 'Добре знати',
  ...
  hu: {
    ...
    'rp.priceNote': 'A dátumaidra érvényes pontos árat foglaláskor látod.',
    'rp.bookOnline': 'Foglalás a Booking.com-on',
    'rp.directTitle': 'Foglalj közvetlenül',
    'rp.directText': 'Hívd a recepciót, vagy írj WhatsAppon. Megmondjuk, van-e szabad szoba a dátumaidra, és válaszolunk a kérdéseidre.',
    'rp.call': 'Hívás',
  ...
  en: {
    ...
    'rp.directText': 'Call reception or message us on WhatsApp. We will tell you whether the room is free on your dates and answer any questions.',
    'rp.call': 'Call',
