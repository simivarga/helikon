...
export const ui: Record<Locale, Dict> = {
  ...
  hu: {
    ...
    'welcome.title': 'Szálloda, amely évről évre nőtt',
    'welcome.body1': 'A Helikon Makkosjánosiban található, Beregszásztól hat kilométerre, a határ felé vezető út mellett. Tizenkilenc szobával indultunk, ma hatvanhárom szobával várunk. Közben park is lett az épület mellett, tavacskával, kishíddal és filagóriákkal.',
    ...
    'pool.body':
      'A vizet két napelemes hőszivattyú fűti, így a nyár elejétől október közepéig kellemes a fürdés. A mélyebbik része másfél méter mély, úgyhogy itt úszni is lehet, nem csak pancsolni.',
    ...
    'rooms.lede': 'A tetőablakos manzárdtól a kétszobás családi lakosztályig. Mindegyikben van légkondi, saját fürdőszoba, tévé és ingyenes wifi.',
    'rooms.from': 'már',
    'rooms.night': '/ éj',
    ...
    'restaurant.body': 'Kárpátaljai és magyar fogásokat készítünk friss, helyi alapanyagokból. A reggeli benne van a szoba árában: reggelente svédasztal vár, meleg ételekkel, sajtokkal és gyümölccsel. Ebédre és vacsorára az étlapról választhatsz.',
    ...
    'events.lede': 'Az első esküvőt 2014-ben tartottuk, azóta több száz követte. Az ételeket a saját konyhánk készíti, a vendégeknek szobát is adunk, és a parkoló a területen belül van.',
    ...
    'grounds.lede': 'A terület a vendégeké: sétautak öreg fák alatt, kishíd a tavon, filagóriák a piknikhez, játszótér és biliárdasztal.',
    ...
    'story.body2': 'A bővítés 2014-ben volt, épp amikor leállt a turizmus. Az építkezést mégis végigvitték, és még abban az évben megtartották az első esküvőt. Ma a szállodát Bíró Tibor vezeti a családjával. Hatvanhárom szoba, egy 250 fős étterem és négy konferenciaterem (12–120 főre) vár a vendégekre, és van sószoba, szauna, biliárdasztal és szabadtéri fűtött medence is.',
    'story.q1': '2004',
    ...
    'contact.borderNote': 'Csendes falu Beregszásztól hat kilométerre. A közelben termálfürdők és borospincék vannak, és néhány vár is elérhető autóval.',
  ...
  en: {
    ...
    'restaurant.body': 'We cook Transcarpathian and Hungarian dishes using fresh local ingredients. Breakfast is included: a table set with warm dishes, cheeses and fruit. Lunch and dinner are chosen from the menu.',
    ...
    'wellness.sauna.desc': 'Finnish sauna with a plunge pool. Available by arrangement, so call ahead and ask about the price.',
    ...
    'events.banquet.desc': 'A large hall for weddings, birthdays and anniversaries. We plan the menu together with you.',
    ...
    'story.body2': 'The expansion came in 2014, just as tourism stopped. The expansion went ahead anyway, and the first wedding was held that same year. Today Tibor Bíró runs the hotel with his family. Guests will find 63 rooms, four conference rooms for 12 to 120 people, a 250-seat restaurant, a salt room, a sauna, billiards and an open-air heated pool.',
    'story.q1': '2004',
    ...
    'contact.borderNote': 'A quiet village six kilometres from Berehove. Thermal baths and wine cellars are close by, and several castles are a short drive away.',
